        ...
        do{
            ...
            switch(op1){
                ...
                case 2:
                    ...
                    System.out.println("Introduzca el ISBN (código de id):");
                    String ISBN = lib.nextLine();
                    System.out.println("Introduzca el número de páginas:");
                    int paginas = lib.nextInt(); lib.nextLine();
                    librito.add(new Libro( libro,ISBN, paginas));
                    break;
                case 3:
                ...
                case 6:
                    ...
                    String finalISBN = lib.nextLine();
                    librito.removeIf(s -> s.getISBN().equals(finalISBN));
                    break;
                case 0:
                    x=false;
                    break;
